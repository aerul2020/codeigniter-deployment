                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <label for="inputOldPassword" class="col-sm-3 col-form-label">Nama
                                        Perusahaan</label>
                                    <div class="col-sm-8">
                                        <input type="text" required <?php echo $readonlyAttribute; ?>
                                               name="nama_institusi"
                                               value="<?php echo ($profil !== null) ? $profil->nama_institusi : ''; ?>"
                                               class="form-control" placeholder="Nama Perusahaan" autocomplete="off">
                                        <?php echo form_error('nama_institusi'); ?>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputNewPassword" class="col-sm-3 col-form-label">No. Telpon</label>
                                    <div class="col-sm-8">
                                        <input type="text" required <?php echo $readonlyAttribute; ?> name="telpon"
                                               value="<?php echo ($profil !== null) ? $profil->telpon : ''; ?>"
                                               class="form-control" maxlength="30" placeholder="No. Telpon"
                                               autocomplete="off">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="email" required <?php echo $readonlyAttribute; ?> name="email"
                                               value="<?php echo ($profil !== null) ? $profil->email : ''; ?>"
                                               class="form-control" id="inputEmail3" placeholder="Alamat email"
                                               autocomplete="off">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea name="alamat" required <?php echo $readonlyAttribute; ?> id=""
                                                  cols="30" rows="10"
                                                  class="form-control"><?php echo ($profil !== null) ? $profil->alamat : ''; ?></textarea>
                                ...
                                <div class="col-sm-8 offset-3">
                                    <?php if ($uri2 !== '' && $uri2 === "edit") : ?>
                                        <button name="update" class="btn btn-primary mr-1" type="submit">Simpan
                                            Perubahan
                                        </button>
                                        <a href="<?php echo base_url('profil-perusahaan'); ?>" class="btn btn-light">Kembali</a>
                                    <?php else: ?>
                                        <a href="<?php echo base_url('profil-perusahaan/edit'); ?>"
                    ...
                    <div class="col-12 col-md-4 col-lg-4">
                        <div class="card card-primary">
                            ...
                            <div class="card-body text-center">
                                <p class="mb-5">
                                    <img src="<?php echo ($profil !== null && $profil->logo !== '' && file_exists(FCPATH . $profil->logo)) ? base_url($profil->logo) : base_url('assets/img/stisla.svg'); ?>"
                                         alt="" class="img img-fluid" style="width: 220px;">
                                </p>
                                <button class="btn btn-primary btn-lg btn-block" type="button" data-toggle="modal"
                                        data-target="#form-upload-modal">
                                    Ubah Logo
                                </button>
                            </div>
                        </div>
...
<div class="modal fade" tabindex="-1" role="dialog" id="form-upload-modal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?php echo base_url('profil-perusahaan/upload'); ?>" id="form-logo" method="POST"
