            ...
            <div class="row">
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                    <div class="login-brand">
                        <?php if($profil !== null && $profil->logo !== '' && file_exists(FCPATH . $profil->logo)): ?>
                            <img src="<?php echo base_url($profil->logo); ?>" alt="logo" width="100"
                             class="shadow-light">
                        <?php else: ?>
                    ...
                    <div class="simple-footer">
                        Copyright &copy; <?php echo ($profil !== '') ? $profil->nama_institusi : 'CV Hanafi ID' ?> - <?php echo date('Y') ?>
                    </div>
                </div>
            </div>
        </div>
