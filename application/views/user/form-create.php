                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="level" id="inputSelect" required class="form-control">
                                            ...
                                            <option <?= (set_value('level') !== '' && set_value('level') === '1') ? 'selected' : '' ?> value="1">Administrator</option>
                                            <option <?= (set_value('level') !== '' && set_value('level') === '0') ? 'selected' : '' ?> value="0">Operator</option>
                                        </select>
