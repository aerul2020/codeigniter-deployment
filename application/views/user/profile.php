<?php
$userPictureSrc = (getUser('foto') !== '' && file_exists(FCPATH  . '/'. getUser('foto'))) ? getUser('foto') : 'assets/img/avatar/avatar-default.png';
?>
<!-- Main Content -->
				...
				<div class="col-12 col-md-12 col-lg-5">
					<div class="card card-primary">
						...
						<div class="card-body text-center">
							...
							<h6 class="badge badge-primary text-uppercase"><?php echo (int) $user->level === 1 ? 'Administrator' : 'Operartor' ?></h6>
						</div>
					...
					<div class="card card-primary">
						<form method="post" class="needs-validation" action="<?php echo base_url('user/profile') ?>">
							...
							<div class="card-body">
								...
								<div class="form-group row">
									<label for="" class="col-sm-3 col-form-label">Level Pengguna</label>
									<div class="col-sm-9">
                                        <input type="text" value="<?php echo (int) $user->level === 1 ? 'Administrator' : 'Operartor' ?>" class="form-control" readonly>
		...
		<div class="modal-content">
			<form action="<?php echo base_url('user/change-picture'); ?>" id="form-logo" method="POST" enctype="multipart/form-data">
				...
				<div class="modal-body pb-0">
					...
					<input type="file" accept="image/*" name="foto" id="inputFile" class="form-control" required>
					<?php
